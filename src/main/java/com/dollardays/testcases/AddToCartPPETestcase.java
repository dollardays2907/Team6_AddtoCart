...
public class AddToCartPPETestcase extends BaseTest {
	...
	public void TC_01_validate_clear_cart_hyperlink_in_the_shopping_cart_page (Hashtable<String, String> datatable) throws InterruptedException, UnsupportedEncodingException, GeneralSecurityException{
	...
	@DDDataProvider(datafile = "testdata/Team6_AddToCart_data.xlsx", sheetName = "AddToCartPPE",  testcaseID = "TC1", runmode = "yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
	public void TC_02_validate_the_user_is_able_to_add_one_item_from_ppe_category_throught_product_page_and_verify_cart_icon(Hashtable<String, String> datatable) throws InterruptedException, UnsupportedEncodingException, GeneralSecurityException{
	...
	@DDDataProvider(datafile = "testdata/Team6_AddToCart_data.xlsx", sheetName = "AddTOCartPPE",  testcaseID = "TC1", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
	public void TC_03_Validate_the_user_is_able_to_add_one_item_to_the_cart_from_PPE_and_Mask_category_and_verify_cart_icon (Hashtable<String, String> datatable) throws InterruptedException, UnsupportedEncodingException, GeneralSecurityException{
		LoginPage loginPage = new LoginPage(driver);
		ExtentTestManager.getTest().log(Status.PASS, "Step  : Login with Valid credentials");
		loginPage.login(datatable.get("UserName"), Base64.decrypt(datatable.get("Password")));
		Thread.sleep(1000);
